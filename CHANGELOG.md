...
### Added
- Docs: a themed (light/dark) **demo GIF** in the README — the Founder's Copilot workflow captured on the
  live site via polyfetch's Playwright tier, shown via `<picture>` (GitHub theme-aware).
