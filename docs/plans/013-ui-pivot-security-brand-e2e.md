...
**Originally handoff 013 — "UI pivot (security · console-gate · brand · e2e · civic · security-review): 8/8
DONE, live on sortmy.london" (updated 2026-07-18).** Approved **full scope**; started at 0/7 shipped, finished
8/8 (see the Progress table below for final PR references).
...
012/010/011 docs) — user decision (merge or close; outside this plan's scope).
...
least-privilege. Fixes as `fix/sec-*`; final e2e console capture as the gate. Record findings in `docs/adr/` or this
