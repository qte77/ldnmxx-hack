...
type: plan
status: "rows 1-5 shipped (ADR 0007 + JSON-RPC dispatch + 4 tool wrappers + server-card.json + discovery links); rows 6-9 not started (2026-09-22)"
refs:
...
**Status: rows 1-5 shipped** — row 1 (ADR 0007, PR [#319](https://github.com/qte77/ldnmxx-hack/pull/319)),
...
cross-links, PR [#326](https://github.com/qte77/ldnmxx-hack/pull/326)). Row 6 (e2e verification) still
running as a parallel worktree agent; rows 7-9 not started. Everything below was scoped
