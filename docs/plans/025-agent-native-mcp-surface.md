...
**Status: row 1 (ADR 0007, PR [#319](https://github.com/qte77/ldnmxx-hack/pull/319)) and rows 2-3
(JSON-RPC dispatch + 4 tool wrappers, PR [#320](https://github.com/qte77/ldnmxx-hack/pull/320))
shipped; rows 4-9 not started — next is row 4 (server-card.json).** Everything below was scoped
