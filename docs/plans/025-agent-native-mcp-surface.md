...
**Status: row 1 (ADR 0007, PR [#319](https://github.com/qte77/ldnmxx-hack/pull/319)), rows 2-3
(JSON-RPC dispatch + 4 tool wrappers, PR [#320](https://github.com/qte77/ldnmxx-hack/pull/320)), and
row 4 (server-card.json, PR [#322](https://github.com/qte77/ldnmxx-hack/pull/322)) shipped; rows 5-9
not started — next is rows 5-6 in parallel (discovery cross-links + e2e).** Everything below was scoped
