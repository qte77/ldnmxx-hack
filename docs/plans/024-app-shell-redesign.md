...
**Status: P0–P4 shipped (rows 1–7 merged); P5 in progress (row 8, this PR).** Rows 9–10 (version
...
housekeeping pass) is this PR — see the "Row 8 findings" note below for a real bug it found and fixed.
