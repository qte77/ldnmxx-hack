...
type: plan
status: "rows 1-2,4 shipped (logo + hero rewrite + trust bar); row 3 in flight; rows 5-8 not started (2026-09-22)"
refs:
...
**Status: row 1 (logo, PR [#321](https://github.com/qte77/ldnmxx-hack/pull/321)), row 2 (hero rewrite,
PR [#323](https://github.com/qte77/ldnmxx-hack/pull/323)), and row 4 (trust bar, PR
[#324](https://github.com/qte77/ldnmxx-hack/pull/324)) shipped; row 3 (category icons) still running
as a parallel worktree agent; rows 5-8 not started.** Scoped from a direct design↔live diff
